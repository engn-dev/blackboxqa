# BlackboxQA scripting API — full reference
...
<!-- blackboxqa:snippet api-playwright-methods -->
...
<!-- blackboxqa:end api-playwright-methods -->
...
<!-- blackboxqa:snippet rule-dev-server -->
...
<!-- blackboxqa:end rule-dev-server -->
