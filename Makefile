# blackboxqa — developer task runner
#
...
BROWSER := @blackboxqa/browser
DAEMON  := @blackboxqa/daemon
UI      := @blackboxqa/ui
CLI     := @blackboxqa/cli
...
dev-browser: ## Run the blackboxqa-browser CLI from source (tsx)
...
dev-cli: ## Run the blackboxqa session orchestrator from source (tsx)
...
build-browser: ## Build blackboxqa-browser (builds + embeds the daemon first)
...
build-cli: ## Build the blackboxqa session orchestrator
...
test-browser: ## Test blackboxqa-browser
...
test-cli: ## Test the blackboxqa session orchestrator
	$(TURBO) run test --filter=$(CLI)

watch-browser: build-daemon ## Watch-test blackboxqa-browser (needs daemon built)
...
watch-cli: ## Watch-test the blackboxqa session orchestrator
