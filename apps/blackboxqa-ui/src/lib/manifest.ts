// Local, structural mirror of the blackboxqa `results.json` schema (the
// `SessionManifest` written by apps/blackboxqa/src/report/manifest.ts). The UI owns
// this copy on purpose: the @blackboxqa/* packages export only a raw-TS `source`
...
export interface SessionManifest {
  ...
  id: string;
  kind: "blackboxqa-session-result";
...
export function isSessionManifest(value: unknown): value is SessionManifest {
  ...
  return (
    value.kind === "blackboxqa-session-result" &&
