...
import { sessionDir } from "@blackboxqa/daemon-client";
...
// stale no matter how long its critical section runs — a `blackboxqa run` can hold
...
// because concurrent `blackboxqa run --session X` invocations are separate
